...
# EXPERIMENT_NAME=qwen3_4b_gh_patches_10k
EXPERIMENT_NAME=qwen3_4b_gh_patches_16k
...
TRAIN_FILE=~/persistent/data/github_patches_4k/train.parquet
TEST_FILE=~/persistent/data/github_patches_4k/test.parquet
